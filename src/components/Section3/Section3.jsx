                    ...
                    <div className="row d-flex ">
                        ...
                        <div className="container">
                            <div className="row d-flex col  justify-content-center">
                                ...
                                <div className="btn btn-primary  col col-sm-4 me-3 mt-2 p-1"><a href="https://mobiless-store.netlify.app/" target="_blank">Demo</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row d-flex ">
                        ...
                        <div className="container">
                            <div className="row d-flex col  justify-content-center">
                                ...
                                <div className="btn btn-primary  col col-sm-4 me-3 mt-2 p-1"><a href="https://github.com/ezequielg1989/tienda-ecommerce" target="_blank">GitHub</a></div>
                                <div className="btn btn-primary  col col-sm-4 me-3 mt-2 p-1"><a href="https://dancca.netlify.app/" target="_blank">Demo</a></div>
                            </div>
                        </div>
                    </div>
                </div>
