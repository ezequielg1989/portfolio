      ...
      <div className="container animate__animated animate__fadeInUp">
        <div className="row justify-content-center mt-5">
            <div className="col-10 col-lg-5 col-md-4 col-sm-10 box">
                <div className="container col text-center">
                    <div className="row d-flex ">
                        <img className='img-port mt-3' src="../public/img/Captura de pantalla de 2022-04-20 18-04-20.jpg" alt="" />
            ...
            <div className="col-10 col-lg-5 col-md-4 col-sm-10  box">
                <div className="container col text-center">
                    <div className="row d-flex ">
                        <img className='img-port mt-3' src="public/Captura de pantalla de 2022-04-20 18-04-20.jpg" alt="" />
                        <div className="container">
                            <div className="row d-flex col mt-3 justify-content-center">
